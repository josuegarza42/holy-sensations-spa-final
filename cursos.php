    ...
    <div class="col-md-6 mt-3">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form  method="get" action="agregaCurso.php">
                    <div class="mb-3">
                        ...
                        <input type="hidden" name="curso" value=" <?php echo $curso['idCurso'];  ?>">
                        <input type="email" class="form-control" name="correo" id="" aria-describedby="emailHelp">
                    </div>
