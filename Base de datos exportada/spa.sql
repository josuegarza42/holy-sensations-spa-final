...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-12-2021 a las 01:57:37
...
INSERT INTO `informacion` (`idCurso`, `correo`) VALUES
(5, 'negociosgarzas@gmail.com'),
(5, 'negociosgarzas@gmail.com'),
(5, 'profeedgar@gmail.pasemeporfavor'),
(6, 'profeedgar@gmail.pasemeporfavor');
...
(35, '  Desodorante', '  Desodorante con olor fresco que te hara sentir fresco todo el dia', 69, 4, '  Deshodorante', '1638839803_desodorante.jfif'),
(36, 'Mascarilla', 'Mascarillas antiacné ', 100, 9, 'Mascarillas', '1638839963_mascarillas.jfif'),
(37, ' crema 2', '  crema para barros de chavos', 99, 5, ' cremas', '1639084951_Faciales.png');
...
(4, 'josue', '123', '123', 'yoshogarza42@gmail.com', 'Privada manuela lopez de lara #110-a colonia los reyitos', 2),
(5, 'marco', '123', '123', 'yoshogarza42@gmail.com', 'Arbolitos #666', 1),
(14, 'Profe edgar', '123', '123', 'profeedgar@gmail.com', 'Lomas 4 seccion ', 1);
...
--
ALTER TABLE `informacion`
  ADD CONSTRAINT `informacion_ibfk_1` FOREIGN KEY (`idCurso`) REFERENCES `curso` (`idCurso`);
